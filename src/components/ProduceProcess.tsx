...
export default function ProduceProcess({}: Props) {
  ...
  return (
    <div>
      ...
      `}</style>
      <h3 className="text-left my-7 text-2xl font-bold border-b border-[var(--red)] w-fit pb-2">
        Quy trình sản xuất
      </h3>
        ...
        <div className="process-thumbs flex justify-evenly items-center">
          ...
          >
            <Image
              ...
              alt="lienhe"
            />
            <h4 className="uppercase pointer-events-none select-none">liên hệ</h4>
          </div>
          <div
          ...
          >
            <Image
              ...
              alt="tuvan"
            />
            <h4 className="uppercase pointer-events-none select-none">tƯ VẤN</h4>
          </div>
          <div
          ...
          >
            <Image
              ...
              alt="thietke"
            />
            <h4 className="uppercase pointer-events-none select-none">thiết kế</h4>
          </div>
          <div
          ...
          >
            <Image
              ...
              alt="sanxuat"
            />
            <h4 className="uppercase pointer-events-none select-none">sản xuất</h4>
          </div>
          <div
          ...
          >
            <Image
              ...
              alt="giohang"
            />
            <h4 className="uppercase pointer-events-none select-none">giao HÀNG</h4>
          </div>
        </div>
