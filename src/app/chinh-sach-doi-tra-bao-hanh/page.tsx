  ...
  return (
    <div className="container mx-auto rock:text-base text-sm">
      ...
      <h3 className="font-bold rock:text-2xl text-xl">
        Chính sách đổi trả - bảo hành của In Ấn Hùng Nguyệt
      </h3>
      ...
      <h3 className="italic my-4 ">
        ...
        Theo đó, In Ấn Hùng Nguyệt đã cải tiến và áp dụng{" "}
        <b>Chính sách bảo hành</b> đối với sản phẩm <b>của In Ấn Hùng Nguyệt</b>
        .
      </h3>
      ...
      <h3>
        <b>
          Chúng tôi luôn mong muốn mang đến cho khách những sự hài lòng tuyệt
          đối nhất!
        </b>
      </h3>
      <h3 className="mt-3 ">
