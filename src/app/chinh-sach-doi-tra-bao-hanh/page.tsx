    ...
    <div className="container mx-auto rock:text-base text-sm">
      ...
      <section>
        ...
        <ul className="list-disc">
          ...
          <li className="rock:mb-2 mb-1">
            Lỗi do quá trình vận chuyển từ phía công ty chúng tôi đến quý khách
            hàng.
          </li>
        </ul>
        <h5 className="rock:my-5 my-3 ">
        ...
        <ul className="list-disc">
          ...
          <li className="rock:mb-2 mb-1 ">
            Sản phẩm bị hư hỏng và lỗi từ phía khách hàng gây nên như trầy xước,
            sản phẩm không còn nguyên vẹn do các tác động ngoại lực hoặc bị ảnh
            hưởng bởi thời tiết (gió, mưa) trong quá trình sử dụng.
          </li>
        </ul>
        <h5 className="mb-2 ">
          – Trong mọi trường hợp, quyết định của In Ấn Hùng Nguyệt là quyết định
          cuối cùng.
        </h5>
        <h5>
          {" "}
          – Lưu ý: Tránh để xảy ra những trường hợp không mong muốn, khi nhận
